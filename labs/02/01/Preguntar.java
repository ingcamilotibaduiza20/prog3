        ...
        switch (opcion) {
            case 1 -> {
                if (filaMatriz1 == filaMatriz2 && columnaMatriz1 == columnaMatriz2) {
                    ...
                    Imprimir.imprimirMatriz(sumaMatrices);
                } else {
            ...
            case 2 -> {
                if (columnaMatriz1 == filaMatriz2) {
                    ...
                    Imprimir.imprimirMatriz(productoMatrices);
                } else {
            ...
            case 3 -> {
                ...
                Imprimir.imprimirMatriz(productoEscalarMatriz);
            }

            case 4 -> {
                double[][] matrizTranspuesta = Operacion.calcularMatrizTranspuesta(matriz1);
                Imprimir.imprimirMatriz(matrizTranspuesta);
            }
